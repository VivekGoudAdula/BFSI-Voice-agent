...
from app.api import agents, calls, customers, elevenlabs, media_stream, tools, webhooks
...
app = FastAPI(
    ...
    description=(
        ...
        "Phase 4: action-taking BFSI agent with tool calling, banking integrations, "
        "and audit logging."
    ),
    version="4.0.0",
    lifespan=lifespan,
